...
public partial class MainWindow : Window
{
    ...
    private async void UpdateDownload_Click(object s, RoutedEventArgs e)
    {
        ...
        UpdateDownloadBtn.Content = "⏳ Скачиваю...";

        try
        {
            var desktop    = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
            var folderName = $"HomeworkGate_v{(_updateInfo?.Version ?? "new")}";
            var destFolder = System.IO.Path.Combine(desktop, folderName);
            var zipPath    = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "HomeworkGate_update.zip");
            ...
            UpdateDownloadBtn.Content = "📦 Распаковываю...";
            ...
            // Открываем папку на рабочем столе
            ...
            System.Windows.MessageBox.Show(
                $"✅ Готово! Папка {folderName} открыта на рабочем столе.\nЗапусти HomeworkGate.exe из неё.",
                "Обновление скачано", MessageBoxButton.OK, MessageBoxImage.Information);
        }
        catch (Exception ex)
        {
            ...
            UpdateDownloadBtn.Content = "⬇ Скачать";
        }
    }
